...
function HotelReserve() {
    ...
    var id_hotel = hotelSelected.id;
    // console.log('car id :',id_car)
    var reservation_checkin = localStorage.getItem('checkIn');
    var reservation_checkout = localStorage.getItem('checkOut');
    ...
    const sendDataUser = () =>{
        ...
        axios.post('http://localhost:5000/api/sendHotelUserInfos',userData )
        .then((response) => {
  ...
  return (
    ...
    {showThanksMessage ? (
      ...
      <div className="popup">
        <h1>Hotel Reservations informations</h1>
